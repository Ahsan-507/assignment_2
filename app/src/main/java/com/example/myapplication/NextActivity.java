    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"bsef20a517@pucit.edu.pk"}); // Replace with your recipient email

                // Show a confirmation message to the user
                Toast.makeText(getApplicationContext(), "Sending email to bsef20a517@pucit.edu.pk", Toast.LENGTH_SHORT).show();
        ...
        whatsappButton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://wa.me/03186595507"); // Replace with the recipient's phone number
        ...
        websiteButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://adley.ai"); // Replace with the URL of the website
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
